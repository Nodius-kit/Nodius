...
export class WebGpuMotor implements GraphicalMotor {
    ...
    private renderLoop = (): void => {
        ...
        if(this.scene) {
            this.nodeRenderer!.buildNodeBuffer(this.scene!.nodes);
            this.edgeRenderer!.buildEdgeBuffer(this.scene!.edges, this.scene!.nodes);
        }
        this.dirty = false;
        ...
        if(this.scene) {
            // Draw nodes
            this.nodeRenderer!.render(passEncoder, this.bindGroup!, this.scene!.nodes.size);
