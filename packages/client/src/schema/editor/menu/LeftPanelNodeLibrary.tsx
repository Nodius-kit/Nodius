...
import {NodeTypeConfig} from "@nodius/utils";
import {disableTextSelection, enableTextSelection} from "@nodius/utils";
import {createNodeFromConfig} from "@nodius/utils";
...
export const LeftPanelNodeLibrary = memo(({
        ...
        const mouseUp = async (evt:MouseEvent) => {
            ...
            if(!haveMoved) {
                ...
                if(isHoverCanvas) {
                    ...
                    const pos = Project.state.getMotor()!.screenToWorld({
                        x: evt.clientX,
                        y: evt.clientY,
                    })
    ...
    return (
        <div style={{display: "flex", width: "100%", height: "100%", flexDirection: "column", padding: "8px", gap: "12px", overflow: "hidden"}}>
            ...
            <div style={{flex: 1, overflow: "auto", display: "flex", flexDirection: "column", gap: "8px", padding:"6px"}}>
                {!hasNodes ? (
                    <div className={classEmptyState}>
