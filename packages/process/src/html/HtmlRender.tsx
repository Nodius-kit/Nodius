...
import {HtmlObject, HtmlBase, HTMLWorkflowEvent, deepCopy, deepEqual, applyCSSBlocks, removeCSSBlocks} from "@nodius/utils";
...
export class HtmlRender {
    ...
    private async renderCreate(object: HtmlObject, parent: HTMLElement,  insertBefore: Node | null = null) {
        ...
        if (object.type === "icon") {
            ...
            if (!Icon) {
                console.log("not found", object.content, Icons);
